...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notecard.notecard_html'
        db.add_column('notecards_notecard', 'notecard_html',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Notecard.notecard_html'
        db.delete_column('notecards_notecard', 'notecard_html')
