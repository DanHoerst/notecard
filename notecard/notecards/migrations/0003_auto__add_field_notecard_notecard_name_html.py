...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notecard.notecard_name_html'
        db.add_column('notecards_notecard', 'notecard_name_html',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Notecard.notecard_name_html'
        db.delete_column('notecards_notecard', 'notecard_name_html')
    ...
    models = {
        ...
        'notecards.notecard': {
            ...
            'notecard_html': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'notecard_name': ('django.db.models.fields.TextField', [], {}),
            'notecard_name_html': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
